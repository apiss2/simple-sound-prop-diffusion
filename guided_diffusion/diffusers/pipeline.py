...
class SemanticOnlyDDMPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        sample = (
            randn_tensor(shape, generator=generator, device=generator.device)
        ...
        for i, t in enumerate(self.progress_bar(self.scheduler.timesteps)):
            ...
            noise_pred = noise_pred_ucond + guidance_scale * (
                noise_pred_cond - noise_pred_ucond
            )
...
class SemanticOnlyLDMPipeline(DiffusionPipeline):
    ...
    def __init__(
        self, unet: UNet2DSISModel, scheduler: DDPMScheduler, vae: AutoencoderKL
    ):
        super().__init__()
