...
class AutoencoderSIS(AutoencoderKL):
    ...
    def get_config(
        ...
        assert n_blocks_minus_1 == int(n_blocks_minus_1), (
            f"compression should be 2**n {compression} given"
        )
        ...
        assert sample_size in CONFIG_DICT, (
            f"Sample size should be in {list(CONFIG_DICT.keys())}"
        )
